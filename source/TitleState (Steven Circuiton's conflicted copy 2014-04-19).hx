...
class TitleState extends FlxState
{
	...
	override public function update():Void
	{
		...
		if (_introPlaying)
		{
			if (_introTimer > 0.5)
			{
				_infoTxt.text = "One day there was a game jam in Toronto";
			}
			if (_introTimer > 3.5)
			{
				_infoTxt.text = "But this time there was short notice";
			}
			if (_introTimer > 6.5)
			{
				_infoTxt.text = "So it's gonna be trickier than last time";
			}
			if (_introTimer > 9.5)
			{
